...
//
//
//public class StateTGCTimeFirstXiaoGanDong {
...
//                                try {
//                                    zhadaoPredictNextOne(PointMap.get(key));
//                                } catch (IOException e) {
//                                    throw new RuntimeException(e);
//                                }
//                            }else{//没上匝道但数据断连
//                                try {
//                                    PredictNextOne(PointMap.get(key));
//                                } catch (IOException e) {
//                                    throw new RuntimeException(e);
//                                }
//                            }
...
//        }
//
//    private static void zhadaoPredictNextOne(PathPointData data) throws IOException {
//        long currentTime = System.currentTimeMillis();
