...
public class predictFlinkMerge {
...
//                            });
                            ...
                            writer.write("===================next news(No."+newscount+")===================");
                            writer.write(System.lineSeparator());
                            //里程+数据丢失检测 上匝道
...
//                                    }
                                ...
                                try {writer.write("[ROD]" + myTools.PointDataToString(pd));} catch (IOException e) {throw new RuntimeException(e);}
                            }//if (value.getKey()) {//在路上
                    ...
                    if(!tb1&&tcount>10000) {
                        ...
                        System.out.println("time split:"+(t2-t1)+"   tcount:"+tcount +"  end");
                        tcount=0;
                        tb1=true;
                    }
                }
