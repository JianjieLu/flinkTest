...
//
//public class predictFlinkMergecoopy {
...
////                                try (BufferedWriter writer1 = new BufferedWriter(new FileWriter("D:\\learn\\codes\\a_idea_codes\\flinkTest\\src\\main\\java\\whu\\edu\\ljj\\flink\\data\\mergedata\\yuanban.txt",true))) {
...
//
//                            for (PathPoint m : p) {
//                                try (BufferedWriter writer = new BufferedWriter(new FileWriter("D:\\learn\\codes\\a_idea_codes\\flinkTest\\src\\main\\java\\whu\\edu\\ljj\\flink\\data\\mergedata\\result\\resudlt.txt",true))) {
//                                    writer.write(m.getId()+m.getStakeId());
//                                }
...
//                        try (BufferedWriter writer = new BufferedWriter(new FileWriter("D:\\learn\\codes\\a_idea_codes\\flinkTest\\src\\main\\java\\whu\\edu\\ljj\\flink\\data\\mergedata\\result\\result.txt",true))) {
...
//                        //                                });
//                        //                                System.out.println("zamap:"+zaMap.get(new Pair<>(key,pd.getPlateNo()))+"  key,pd.getPlateNo():"+key+"  "+pd.getPlateNo());
...
//                                            list.add(pathPoint);
//                                            writer.write("[ZYV]:" + myTools.PointToString(pathPoint));
//                                        }
//                                    } catch (IOException e) {
//                                        throw new RuntimeException(e);
//                                    }
...
//                                        if (pathPoint != null) {
//                                            list.add(pathPoint);
//                                            writer.write("[RYV]:" + myTools.PointToString(pathPoint));
//                                        }
//
//                                    } catch (IOException e) {
//                                        throw new RuntimeException(e);
...
//                                    Pair<Location, Integer> kkk = null;
//                                    try {
//                                        kkk = LocationOP.UseLLGetSK(pd.getLatitude(), pd.getLongitude(), roadKDataList);
//                                    } catch (IOException e) {
//                                        throw new RuntimeException(e);
//                                    }
...
//                                try {
//                                    writer.write("[ROD]" + myTools.PointDataToString(PointMap.get(key)));
//                                } catch (IOException e) {
//                                    throw new RuntimeException(e);
//                                }
//                            }
//                        }
//                                    try {writer.write(System.lineSeparator());} catch (IOException e) {throw new RuntimeException(e);}
//                                });
//                        writer.write(System.lineSeparator());
//                        writer.write("===================next news===================");
//                        writer.write(System.lineSeparator());}
