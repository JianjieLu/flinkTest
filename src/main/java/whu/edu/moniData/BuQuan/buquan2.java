...
public class buquan2 {
    ...
    public static void main(String[] args) throws Exception {
        try (StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment()) {
            ...
            List<String> topics  = Arrays.asList("MergedPathData.sceneTest.2");
            String groupId = "flink_consumer_group2";
            // 从Kafka读取数据
...
//                    System.out.println(pathTData.getTimeStamp());
            ...
            env.execute("Flink completion to Kafka2 : completed.pathdata");
        }//flink env
