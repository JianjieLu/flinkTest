...
public class buquan3 {
    ...
    public static void main(String[] args) throws Exception {
        try (StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment()) {
            ...
            List<String> topics  = Arrays.asList("MergedPathData.sceneTest.3");
            String groupId = "flink_consumer_group3";
            // 从Kafka读取数据
...
//                            lastMap=tempMap;
            ...
            env.execute("Flink completion to Kafka3 : completed.pathdata");
        }//flink env
