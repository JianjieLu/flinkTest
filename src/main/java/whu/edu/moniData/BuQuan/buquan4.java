...
public class buquan4 {
    ...
    public static void main(String[] args) throws Exception {
        try (StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment()) {
            ...
            List<String> topics  = Arrays.asList("MergedPathData.sceneTest.4");
            String groupId = "flink_consumer_group4";
            // 从Kafka读取数据
...
//                            lastMap=tempMap;
            ...
            env.execute("Flink completion to Kafka 4: completed.pathdata");
        }//flink env
