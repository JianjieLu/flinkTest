...
public class buquan5 {
    ...
    public static void main(String[] args) throws Exception {
        try (StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment()) {
            ...
            List<String> topics  = Arrays.asList("MergedPathData.sceneTest.5");
            String groupId = "flink_consumer_group5";
            // 从Kafka读取数据
...
//                            lastMap=tempMap;
            ...
            env.execute("Flink completion to Kafka 5: completed.pathdata");
        }//flink env
