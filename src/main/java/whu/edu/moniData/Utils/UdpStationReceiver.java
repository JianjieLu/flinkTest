...
public class UdpStationReceiver {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            StationData stationData = parseMessageContent(msgBuffer);

            // TODO: 处理stationData（如发送到Kafka或存储）
            System.out.println("Parsed data: " + stationData);
        }
    }

    private static StationData parseMessageContent(ByteBuffer buffer) {
