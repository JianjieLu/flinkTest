...
//                                System.out.println(data);
            ...
            DataStream<PathTData> mainRoad = kafkaStream
                    .flatMap((String jsonStr, Collector<PathTData> out) -> {
                        try {
//                            System.out.println(jsonStr);
                            PathTData data = null;
...
//                                if(myTools.getNString(jsonStr,2,10).equals("pathList")) {SN
            ...
            DataStream<PathTData> jizhanData = kafkaStream
                    .flatMap((String jsonStr, Collector<PathTData> out) -> {
                        try {
//                            System.out.println(jsonStr);
                            PathTData data = null;
...
//            DataStream<PathTData> parsedStream1=rasterStream.union(StationStream);
            SingleOutputStreamOperator<PathTData> endPathTDataStream = mainRoad.flatMap(new FlatMapFunction<PathTData, PathTData>() {
...
//                        System.out.println(list);
            ...
            SingleOutputStreamOperator<PathTData> jizhanendPathData = mainRoad.flatMap(new FlatMapFunction<PathTData, PathTData>() {
