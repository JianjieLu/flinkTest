...
public class CarTrajStorageJobNoFeature {
    public static void main(String[] args) throws Exception {
        ...
        kafkaStream
                .flatMap(new FlatMapFunction<String, Tuple4<String, Long, List<Tuple4<Double, Double, Integer, Double>>, Integer>>() {
                    @Override
                    public void flatMap(String jsonString, Collector<Tuple4<String, Long, List<Tuple4<Double, Double, Integer, Double>>, Integer>> out) {
                        try {
                            ...
                            out.collect(new Tuple4<>(timeSeg, latestTime, trajectory, dir));
    ...
    private static class DynamicHBaseSink extends RichSinkFunction<Tuple4<String, Long, List<Tuple4<Double, Double, Integer, Double>>, Integer>> {
        ...
        @Override
        public void invoke(Tuple4<String, Long, List<Tuple4<Double, Double, Integer, Double>>, Integer> value, Context context) throws Exception {
            tableLock.lock();
            try {
                ...
                put.addColumn(Bytes.toBytes(columnFamily), Bytes.toBytes("latest_time"), Bytes.toBytes(value.f1.toString()));
                put.addColumn(Bytes.toBytes(columnFamily), Bytes.toBytes("trajectory"), Bytes.toBytes(value.f2.toString()));
                put.addColumn(Bytes.toBytes(columnFamily), Bytes.toBytes("direction"), Bytes.toBytes(value.f3.toString()));
                table.put(put);
            } finally {
                tableLock.unlock();
            }
