...
public class CombinedCarTrajAnalysisJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.execute("Combined Car Trajectory Analysis Job");
    }
    ...
    private static class PrimaryTrajectoryProcessor implements FlatMapFunction<String, String> {
        ...
        private final Map<String, Integer> mapVehicleColor = new ConcurrentHashMap<>();
        private final Map<String, Double> mapVehicleWeight = new ConcurrentHashMap<>();
        private final Map<String, String> mapSpecialFlag = new ConcurrentHashMap<>();
        ...
        private void initializeNewVehicle(String id, String plateNo, JSONObject tdata, long timestamp) {
            ...
            mapVehicleColor.put(id, getVehicleColorSafely(tdata));
            mapVehicleWeight.put(id, getVehicleWeightSafely(tdata));
            mapSpecialFlag.put(id, getSpecialFlagSafely(tdata));
        ...
        private int getVehicleColorSafely(JSONObject tdata) {
            try { return tdata.getInt("vehicleColor"); }
            catch (JSONException e) { return 0; }
        }

        private double getVehicleWeightSafely(JSONObject tdata) {
            try { return tdata.getDouble("vehicleWeight"); }
            catch (JSONException e) { return 0.0; }
        }

        private String getSpecialFlagSafely(JSONObject tdata) {
            try { return tdata.getString("specialFlag"); }
            catch (JSONException e) { return "0"; }
        }
    }
