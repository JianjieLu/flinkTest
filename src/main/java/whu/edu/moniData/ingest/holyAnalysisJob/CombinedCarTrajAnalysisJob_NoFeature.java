...
public class CombinedCarTrajAnalysisJob_NoFeature {
...
//                "fiberData10", "fiberData11");
        List<String> primaryTopics = Arrays.asList("fiberData1", "fiberData2", "fiberData3", "fiberData4", "fiberData5", "fiberData6", "fiberData7", "fiberData8", "fiberData9", "fiberData10", "fiberData11");
