...
public class CombinedCarTrajStorageJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ================== 主数据处理 ==================
        SingleOutputStreamOperator<Tuple9<String, Integer, Long, List<Tuple4<Double, Double, Integer, Double>>,
                Integer, Integer, Double, String, String>> primaryProcessed =
        ...
        env.execute("Combined Car Trajectory Storage Job");
    }

    // ================== 主数据解析器 ==================
    private static class PrimaryJSONParser implements FlatMapFunction<String,
            Tuple9<String, Integer, Long, List<Tuple4<Double, Double, Integer, Double>>,
                    Integer, Integer, Double, String, String>> {

        @Override
        public void flatMap(String jsonString,
                            Collector<Tuple9<String, Integer, Long, List<Tuple4<Double, Double, Integer, Double>>,
                                    Integer, Integer, Double, String, String>> out) {
    ...
    // ================== 主数据HBase Sink ==================
    private static class PrimaryHBaseSink extends RichSinkFunction<Tuple9<String, Integer, Long,
            List<Tuple4<Double, Double, Integer, Double>>, Integer, Integer, Double, String, String>> {
        ...
        @Override
        public void invoke(Tuple9<String, Integer, Long, List<Tuple4<Double, Double, Integer, Double>>,
                Integer, Integer, Double, String, String> value, Context context) throws Exception {
