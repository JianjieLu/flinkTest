...
//        private double mileage;
    ...
    public static class RealTimeSeg implements Serializable {
        ...
        // 车道平均速度
        private double laneNo1AvgSpeed;
        private double laneNo2AvgSpeed;
        private double laneNo3AvgSpeed;
        private double laneNo4AvgSpeed;
    ...
    public static class StakeAssignment implements Serializable {
        ...
        public StakeAssignment(String jsonFilePath) throws IOException {
            // 从Excel文件加载卡口信息
            this.stakeInfoList = loadCheckpointsFromJSON(jsonFilePath);
        }
        ...
        private List<StakeInfo> loadCheckpointsFromJSON(String filePath) throws IOException {
            ...
            // 按纬度由大到小排序
            stakeInfoList.sort((o1, o2) -> Double.compare(stakeToMileage(o1.getStake()), stakeToMileage(o2.getStake())));

            return stakeInfoList;
        }

        public String findNearestStake(double lng, double lat) {
            int left = 0;
    ...
    public static class MileageConverter implements Serializable {
        ...
        private Map<Double, StakeInfo> loadCheckpointsFromJSON(String filePath) throws IOException {
            ...
            // 解析 JSON 数据为 List<StakeInfo>
            List<StakeInfo> stakeInfoList = JSON.parseArray(jsonString, StakeInfo.class);
