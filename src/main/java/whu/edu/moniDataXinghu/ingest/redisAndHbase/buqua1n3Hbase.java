...
public class buqua1n3Hbase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 修改 Sink 创建
//        minuteIndicatorStream.addSink(new IndicatorHBaseSink("minute"));
        hourIndicatorStream.addSink(new IndicatorHBaseSink("hour"));
        dayIndicatorStream.addSink(new IndicatorHBaseSink("day"));
        monthIndicatorStream.addSink(new IndicatorHBaseSink("month"));
...
//        monthIndicatorStream.print("Month Indicators");
        ...
        env.execute("Traffic Indicator Calculation and Storage Job");
    }
    ...
    // 修改 IndicatorHBaseSink 类
    public static class IndicatorHBaseSink extends RichSinkFunction<IndicatorResult> {
        private final String timeType;
        private transient Connection connection;
        private transient Table table;

        public IndicatorHBaseSink(String timeType) {
            this.timeType = timeType;
        }
        ...
        public void invoke(IndicatorResult result, Context context) throws Exception {
            ...
            // 写入HBase
            table.put(put);
            System.out.println("存储指标数据: " + rowKey);
        }
